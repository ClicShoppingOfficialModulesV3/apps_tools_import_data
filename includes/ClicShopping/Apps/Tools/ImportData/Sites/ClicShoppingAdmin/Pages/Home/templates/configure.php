  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-block headerCard">
        <div class="row">
          <span class="col-md-1 logoHeading"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/migration.png', $CLICSHOPPING_ImportData->getDef('heading_title'), '40', '40'); ?></span>
          <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ImportData->getDef('heading_title'); ?></span>
          <span class="col-md-7 text-md-right">
<?php
    echo HTML::button($CLICSHOPPING_ImportData->getDef('button_import_data'), null, $CLICSHOPPING_ImportData->link('ImportData'), 'success');
?>
        </div>
      </div>
    </div>
...
?>
  <form name="CustomersCustomersConfigure" action="<?php echo $CLICSHOPPING_ImportData->link('Configure&Process&module=' . $current_module); ?>" method="post">
...
?>
   <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_ImportData->getConfigModuleInfo($current_module, 'title'); ?></strong></div>
      <div class="adminformTitle">
        <div class="row">
          <div class="separator"></div>
          <div class="col-md-12">
