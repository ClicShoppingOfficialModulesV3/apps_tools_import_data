    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-block headerCard">
          <div class="row">
            <span class="col-md-1"><?php echo HTML::image($CLICSHOPPING_Template->getImageDirectory() . '/categories/migration.png', $CLICSHOPPING_ImportData->getDef('heading_title'), '40', '40'); ?></span>
            <span class="col-md-4 pageHeading"><?php echo '&nbsp;' . $CLICSHOPPING_ImportData->getDef('heading_title'); ?></span>
...
?>
    ...
    <div class="col-md-12 mainTitle"><strong><?php echo $CLICSHOPPING_ImportData->getDef('text_title_step2') ; ?></strong></div>
    <div class="adminformTitle">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_ImportData->getDef('database'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_ImportData->getDef('database'); ?></label>
              <div class="col-md-5">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_ImportData->getDef('username'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_ImportData->getDef('username'); ?></label>
              <div class="col-md-5">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_ImportData->getDef('prefix_tables'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_ImportData->getDef('prefix_tables'); ?></label>
              <div class="col-md-5">
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="form-group row">
              <label for="<?php echo $CLICSHOPPING_ImportData->getDef('select_ecommerce_solution'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_ImportData->getDef('select_ecommerce_solution'); ?></label>
              <div class="col-md-5">
