      ...
      <div class="row">
        <div class="col-md-7">
          <div class="form-group row">
            <label for="<?php echo $CLICSHOPPING_ImportData->getDef('text_select_import'); ?>" class="col-5 col-form-label"><?php echo $CLICSHOPPING_ImportData->getDef('text_select_import'); ?></label>
            <div class="col-md-5">
