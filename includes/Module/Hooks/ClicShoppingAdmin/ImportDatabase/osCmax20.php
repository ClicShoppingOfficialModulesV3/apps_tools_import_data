...
//******************************************
// ** disable languages migration - ejSolutions
...
// End disable languages migration

//**********************************
//products table products description
//**********************************
// Fixed typo in 'products_viewed '      
...
// table_addess_book
//******************************************
// Cater for # in Address - ejSolutions      
...
//Customers
//******************************************
// deal with default date format - ejSolutions
      ...
      while ($data = $Qcustomers->fetch_assoc()) {
        ...
        $sql_data_array = [
          ...
          'languages_id' => 1,
          'customers_group_id' => $data['customers_group_id'],
        ];
        } else {
        $sql_data_array = [
          'customers_id' => (int)$data['customers_id'],
...
//manufacturers
//******************************************
// Remove suppliers_id - ejsolutions
      // 'suppliers_id' => 0
...
//orders
//******************************************
// Added orders_status_invoice - ejSolutions
// Allow # in address for number
...
// orders_status
//******************************************
// Replace any existing order_status - ejSolutions
// Remove support_orders_flag
      ...
      // if ($data['orders_status_id'] > 4) {
		...
		//	echo $data['orders_status_name'] . '<br>';
...
//******************************************
// Correct comments (plural) - ejSolutions
...
//orders_total
//******************************************
// Correct save to table_orders_total - ejSolutions
